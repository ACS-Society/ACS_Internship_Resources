...
function setBigInt64(view, offset, value) {
    var high = Number(value / BigInt(4294967296));
    var low = Number(value % BigInt(4294967296));
    if (high < 0 && low !== 0) {
...
function getInt64(view, offset) {
    ...
    var exceeds_min_safe_int = high < Math.floor(Number.MIN_SAFE_INTEGER / 4294967296) ||
        (high === Math.floor(Number.MIN_SAFE_INTEGER / 4294967296) && low === 0);
    var exceeds_max_safe_int = high > Math.floor(Number.MAX_SAFE_INTEGER / 4294967296);
...
var Encoder_Encoder = /** @class */ (function () {
    ...
    Encoder.prototype.writeBig64 = function (value) {
        this.ensureBufferSizeToWrite(8);
...
var Decoder_Decoder = /** @class */ (function () {
    ...
    Decoder.prototype.doDecodeSingleSync = function () {
